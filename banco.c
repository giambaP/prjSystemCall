...
void play()
{
    ...
    while (loop == true)
    {
        ...
        case PLAY:
        {
            ...
            // croupier role dices
            int croupierFirstDiceResult = randomValue(gameData->croupierCurrentMoney * 10, 1, 6);
            int croupierSecondDiceResult = randomValue(gameData->croupierCurrentMoney * 100, 1, 6);
